...
(function (root, factory) {
     ...
     *
     * @method func
     * @param {Function} fnc  the function to be injected
     * @param {Object} scope : if the function is not used as a constructor
     *                this object is used as this inside the Injected function
     * @param {Array} $inject property is an array of service names to inject for minification code.
